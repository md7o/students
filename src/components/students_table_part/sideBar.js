...
import LogoutModal from "../../components/modal/logout_modal"; // Adjust the path as needed
...
const SideBar = () => {
  ...
  return (
    <div className="flex">
      <div className="xl:w-72 w-16 h-screen flex flex-col justify-between bg-white rounded-b-xl">
        ...
        >
          <img src={power} alt="Logout" className="w-6" />
